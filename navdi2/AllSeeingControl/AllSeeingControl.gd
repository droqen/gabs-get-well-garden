...
export(bool)var random_colour_bg = false
export(bool)var random_project_name = true
...
func make_main():
	...
	if random_project_name:
		set.project_name = NavdiNamer.new().generate_vcname(6,randf()<.75)
